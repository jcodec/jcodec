...
/**
 * This class is needed to be able to mock the bitmap
 */
public class Bitmap implements android.os.Parcelable {
    ...
    public static android.graphics.Bitmap createScaledBitmap(android.graphics.Bitmap src, int dstWidth,
    ...
    public static android.graphics.Bitmap createBitmap(android.graphics.Bitmap source, int x, int y, int width,
            int height) {
        throw new RuntimeException("Stub!");
    }

    public static android.graphics.Bitmap createBitmap(android.graphics.Bitmap source, int x, int y, int width,
            int height, android.graphics.Matrix m, boolean filter) {
        throw new RuntimeException("Stub!");
    }

    public static android.graphics.Bitmap createBitmap(int width, int height,
            android.graphics.Bitmap.Config config) {
        throw new RuntimeException("Stub!");
    }

    public static android.graphics.Bitmap createBitmap(int[] colors, int offset, int stride, int width, int height,
            android.graphics.Bitmap.Config config) {
        throw new RuntimeException("Stub!");
    }
    ...
    public boolean compress(android.graphics.Bitmap.CompressFormat format, int quality,
    ...
    public static  android.os.Parcelable.Creator<android.graphics.Bitmap> CREATOR;
