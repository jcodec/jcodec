...
public enum MKVType {
    ...
    EBML(new byte[]{0x1A, 0x45, (byte)0xDF, (byte)0xA3}, EbmlMaster.class),
      EBMLVersion(new byte[]{0x42, (byte)0x86}, EbmlUint.class),
      EBMLReadVersion(new byte[]{0x42, (byte)0xF7}, EbmlUint.class),
      EBMLMaxIDLength(new byte[]{0x42, (byte)0xF2}, EbmlUint.class),
      EBMLMaxSizeLength(new byte[]{0x42, (byte)0xF3}, EbmlUint.class),
      ...
      DocTypeVersion(new byte[]{0x42, (byte)0x87}, EbmlUint.class),
      DocTypeReadVersion(new byte[]{0x42, (byte)0x85}, EbmlUint.class),
    ...
    Segment(new byte[]{0x18, 0x53, (byte)0x80, 0x67}, MkvSegment.class),
      SeekHead(new byte[]{0x11, 0x4D, (byte)0x9B, 0x74}, EbmlMaster.class),
        Seek(new byte[]{0x4D, (byte)0xBB}, EbmlMaster.class),
          ...
          SeekPosition(new byte[]{0x53, (byte)0xAC}, EbmlUint.class),
      Info(new byte[]{0x15, (byte)0x49, (byte)0xA9, (byte)0x66}, EbmlMaster.class),
        ...
        ChapterTranslate(new byte[]{0x69,0x24}, EbmlMaster.class), 
            ...
            ChapterTranslateEditionUID(new byte[]{0x69, (byte) 0xFC}, EbmlUint.class), 
            //The chapter codec using this ID (0: Matroska Script, 1: DVD-menu).
            ChapterTranslateCodec(new byte[]{0x69, (byte) 0xBF}, EbmlUint.class), 
        ...
        TimecodeScale(new byte[]{0x2A, (byte)0xD7, (byte)0xB1}, EbmlUint.class),
     ...
     Cluster(new byte[]{0x1F, (byte)0x43, (byte)0xB6, (byte)0x75}, EbmlMaster.class), 
         ...
         Timecode(new byte[]{(byte)0xE7}, EbmlUint.class), 
         ...
         SilentTracks(new byte[]{0x58, 0x54}, EbmlMaster.class), 
             ...
             SilentTrackNumber(new byte[]{0x58, (byte)0xD7}, EbmlUint.class), 
         ...
         Position(new byte[]{(byte)0xA7}, EbmlUint.class),  
         // Size of the previous Cluster, in octets. Can be useful for backward playing.
         PrevSize(new byte[]{(byte)0xAB}, EbmlUint.class),  
         ...
         BlockGroup(new byte[]{(byte)0xA0}, EbmlMaster.class), 
           ...
           BlockAdditions(new byte[]{0x75, (byte) 0xA1}, EbmlMaster.class), 
               ...
               BlockMore(new byte[]{(byte)0xA6}, EbmlMaster.class), 
                   ...
                   BlockAddID(new byte[]{(byte)0xEE}, EbmlUint.class), 
           ...
           */
           BlockDuration(new byte[]{(byte)0x9B}, EbmlUint.class),
           ...
           ReferencePriority(new byte[]{(byte) 0xFA}, EbmlUint.class),  
           ...
           Slices(new byte[]{(byte)0x8E}, EbmlMaster.class),
               ...
               TimeSlice(new byte[]{(byte)0xE8}, EbmlMaster.class), 
                   ...
                   LaceNumber(new byte[]{(byte)0xCC}, EbmlUint.class), 
      ...
      Tracks(new byte[]{0x16, (byte)0x54, (byte)0xAE, (byte)0x6B}, EbmlMaster.class), 
        ...
        TrackEntry(new byte[]{(byte)0xAE}, EbmlMaster.class), 
          ...
          TrackNumber(new byte[]{(byte)0xD7}, EbmlUint.class), 
          ...
          FlagForced(new byte[]{0x55,(byte)0xAA}, EbmlUint.class), 
          //   Set if the track may contain blocks using lacing. (1 bit)
          FlagLacing(new byte[]{(byte)0x9C}, EbmlUint.class), 
          ...
          DefaultDuration(new byte[]{0x23, (byte)0xE3, (byte)0x83}, EbmlUint.class), 
          // The maximum value of BlockAddID. A value 0 means there is no BlockAdditions for this track.
          MaxBlockAdditionID(new byte[]{0x55, (byte)0xEE}, EbmlUint.class), 
          ...
          AttachmentLink(new byte[]{0x74, 0x46}, EbmlUint.class), 
          // The codec can decode potentially damaged data (1 bit).
          CodecDecodeAll(new byte[]{(byte)0xAA}, EbmlUint.class), 
          ...
          TrackOverlay(new byte[]{0x6F,(byte)0xAB}, EbmlUint.class), 
          ...
          TrackTranslate(new byte[]{0x66, 0x24}, EbmlMaster.class), 
              ...
              TrackTranslateEditionUID(new byte[]{0x66,(byte)0xFC}, EbmlUint.class), 
              //  The chapter codec using this ID (0: Matroska Script, 1: DVD-menu).
              TrackTranslateCodec(new byte[]{0x66,(byte)0xBF}, EbmlUint.class), 
          ...
          Video(new byte[]{(byte)0xE0}, EbmlMaster.class),
              ...
              FlagInterlaced(new byte[]{(byte)0x9A}, EbmlUint.class), 
              ...
              StereoMode(new byte[]{0x53,(byte)0xB8}, EbmlUint.class), 
              // Alpha Video Mode. Presence of this EbmlBase indicates that the BlockAdditional EbmlBase could contain Alpha data.
              AlphaMode(new byte[]{0x53,(byte)0xC0}, EbmlUint.class), 
              PixelWidth(new byte[]{(byte)0xB0}, EbmlUint.class),
              PixelHeight(new byte[]{(byte)0xBA}, EbmlUint.class),
              //  The number of video pixels to remove at the bottom of the image (for HDTV content).
              PixelCropBottom(new byte[]{0x54,(byte)0xAA}, EbmlUint.class),   
              // The number of video pixels to remove at the top of the image.
              PixelCropTop(new byte[]{0x54,(byte)0xBB}, EbmlUint.class),  
              // The number of video pixels to remove on the left of the image.
              PixelCropLeft(new byte[]{0x54,(byte)0xCC}, EbmlUint.class),  
              //  The number of video pixels to remove on the right of the image.
              PixelCropRight(new byte[]{0x54,(byte)0xDD}, EbmlUint.class),  
              DisplayWidth(new byte[]{0x54, (byte)0xB0}, EbmlUint.class),
              DisplayHeight(new byte[]{0x54, (byte)0xBA}, EbmlUint.class),
              //  How DisplayWidth & DisplayHeight should be interpreted (0: pixels, 1: centimeters, 2: inches, 3: Display Aspect Ratio).
              DisplayUnit(new byte[]{0x54,(byte)0xB2}, EbmlUint.class), 
              //  Specify the possible modifications to the aspect ratio (0: free resizing, 1: keep aspect ratio, 2: fixed).
              AspectRatioType(new byte[]{0x54,(byte)0xB3}, EbmlUint.class), 
          ...
          Audio(new byte[]{(byte)0xE1}, EbmlMaster.class),
              ...
              Channels(new byte[]{(byte)0x9F}, EbmlUint.class),
              BitDepth(new byte[]{0x62, 0x64}, EbmlUint.class),
          ...
          TrackOperation(new byte[]{(byte)0xE2}, EbmlMaster.class),  
              ...
              TrackCombinePlanes(new byte[]{(byte)0xE3}, EbmlMaster.class), 
                  ...
                  TrackPlane(new byte[]{(byte)0xE4}, EbmlMaster.class), 
                      ...
                      TrackPlaneUID(new byte[]{(byte)0xE5}, EbmlUint.class), 
                      //  The kind of plane this track corresponds to (0: left eye, 1: right eye, 2: background).
                      TrackPlaneType(new byte[]{(byte)0xE6}, EbmlUint.class), 
              ...
              TrackJoinBlocks(new byte[]{(byte)0xE9}, EbmlMaster.class), 
                  ...
                  TrackJoinUID(new byte[]{(byte)0xED}, EbmlUint.class), 
          ...
          ContentEncodings(new byte[]{0x6D, (byte)0x80}, EbmlMaster.class), 
              ...
              ContentEncoding(new byte[]{0x62, 0x40}, EbmlMaster.class), 
                  ...
                  ContentEncodingOrder(new byte[]{0x50, 0x31}, EbmlUint.class), 
                  ...
                  ContentEncodingScope(new byte[]{0x50, 0x32}, EbmlUint.class), 
                  //   A value describing what kind of transformation has been done. Possible values: 0 - compression, 1 - encryption
                  ContentEncodingType(new byte[]{0x50, 0x33}, EbmlUint.class), 
                  ...
                  //  The compression algorithm used. Algorithms that have been specified so far are: 0 - zlib, 1 - bzlib, 2 - lzo1x, 3 - Header Stripping
                      ContentCompAlgo(new byte[]{0x42, (byte)0x54}, EbmlUint.class), 
                  ...
                  //  The encryption algorithm used. The value '0' means that the contents have not been encrypted but only signed. Predefined values: 1 - DES, 2 - 3DES, 3 - Twofish, 4 - Blowfish, 5 - AES
                      ContentEncAlgo(new byte[]{0x47, (byte)0xE1}, EbmlUint.class), 
                      ...
                      ContentSigAlgo(new byte[]{0x47, (byte)0xE5}, EbmlUint.class), 
                      ...
                      ContentSigHashAlgo(new byte[]{0x47, (byte)0xE6}, EbmlUint.class), 
        ...
        Cues(new byte[]{0x1C,0x53,(byte)0xBB,0x6B}, EbmlMaster.class),
           CuePoint(new byte[]{(byte)0xBB}, EbmlMaster.class),
               ...
               CueTrackPositions(new byte[]{(byte)0xB7}, EbmlMaster.class),
                   ...
                   CueRelativePosition(new byte[]{(byte)0xF0}, EbmlUint.class), 
                   ...
                   CueDuration(new byte[]{(byte)0xB2}, EbmlUint.class), 
                   //Number of the Block in the specified Cluster.
                   CueBlockNumber(new byte[]{0x53, 0x78}, EbmlUint.class), 
                   ...
                   CueCodecState(new byte[]{(byte)0xEA}, EbmlUint.class), 
                   ...
                   // Timecode of the referenced Block.
                       CueRefTime(new byte[]{(byte)0x96}, EbmlUint.class),
      ...
      Attachments(new byte[]{0x19, 0x41, (byte)0xA4, 0x69}, EbmlMaster.class),
        AttachedFile(new byte[]{0x61, (byte)0xA7}, EbmlMaster.class),
          ...
          FileUID(new byte[]{0x46, (byte)0xAE}, EbmlUint.class),
     ...
     Chapters(new byte[]{0x10, (byte)0x43, (byte)0xA7, (byte)0x70}, EbmlMaster.class),
      EditionEntry(new byte[]{(byte)0x45, (byte)0xB9}, EbmlMaster.class),
        EditionUID(new byte[]{(byte)0x45, (byte)0xBC}, EbmlUint.class),
        EditionFlagHidden(new byte[]{(byte)0x45, (byte)0xBD}, EbmlUint.class),
        EditionFlagDefault(new byte[]{(byte)0x45, (byte)0xDB}, EbmlUint.class),
        EditionFlagOrdered(new byte[]{(byte)0x45, (byte)0xDD}, EbmlUint.class),
        ChapterAtom(new byte[]{(byte)0xB6}, EbmlMaster.class),
          ChapterUID(new byte[]{(byte)0x73, (byte)0xC4}, EbmlUint.class),
          ...
          ChapterTimeStart(new byte[]{(byte)0x91}, EbmlUint.class),
          ChapterTimeEnd(new byte[]{(byte)0x92}, EbmlUint.class),
          ChapterFlagHidden(new byte[]{(byte)0x98}, EbmlUint.class),
          ChapterFlagEnabled(new byte[]{(byte)0x45, (byte)0x98}, EbmlUint.class),
          ...
          ChapterSegmentEditionUID(new byte[]{0x6E,(byte)0xBC}, EbmlUint.class), 
          ChapterPhysicalEquiv(new byte[]{(byte)0x63, (byte)0xC3}, EbmlUint.class),
          ChapterTrack(new byte[]{(byte)0x8F}, EbmlMaster.class),
            ChapterTrackNumber(new byte[]{(byte)0x89}, EbmlUint.class),
          ...
          // Contains the type of the codec used for the processing. A value of 0 means native Matroska processing (to be defined), a value of 1 means the DVD command set is used. More codec IDs can be added later.
            ChapProcessCodecID(new byte[]{0x69, 0x55}, EbmlUint.class), 
            ...
            // Defines when the process command should be handled (0: during the whole chapter, 1: before starting playback, 2: after playback of the chapter).
              ChapProcessTime(new byte[]{0x69, 0x22}, EbmlUint.class), 
      ...
      Tags(new byte[]{0x12, (byte)0x54, (byte)0xC3, (byte)0x67}, EbmlMaster.class),
          Tag(new byte[]{0x73, (byte)0x73}, EbmlMaster.class),
              Targets(new byte[]{0x63, (byte)0xC0}, EbmlMaster.class),
                  TargetTypeValue(new byte[]{0x68, (byte) 0xCA}, EbmlUint.class),
                  TargetType(new byte[]{0x63,(byte)0xCA}, EbmlString.class),
                  TagTrackUID(new byte[]{0x63, (byte)0xC5}, EbmlUint.class),
                  ...
                  TagEditionUID(new byte[]{0x63,(byte)0xC9}, EbmlUint.class), 
                  TagChapterUID(new byte[]{0x63, (byte)0xC4}, EbmlUint.class),
                  TagAttachmentUID(new byte[]{0x63, (byte)0xC6}, EbmlUint.class),
              SimpleTag(new byte[]{0x67, (byte)0xC8}, EbmlMaster.class),
                  ...
                  TagDefault(new byte[]{0x44, (byte)0x84}, EbmlUint.class),
