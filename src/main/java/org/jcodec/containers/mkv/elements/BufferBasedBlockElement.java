...
public class BufferBasedBlockElement extends BinaryElement {
    ...
    public static BufferBasedBlockElement copy(BufferBasedBlockElement old){
        BufferBasedBlockElement be = new BufferBasedBlockElement(old.id);
    ...
    public static BufferBasedBlockElement keyFrame(long trackNumber, int timecode, ByteBuffer frame){
        BufferBasedBlockElement be = new BufferBasedBlockElement(Type.SimpleBlock.id);
        be.frames = new ByteBuffer[]{frame};
        be.frameSizes = new long[]{frame.limit()};
        be.keyFrame = true;
    ...
    public BufferBasedBlockElement(byte[] type) {
        super(type);
...
//        dataOffset = source.position();
    ...
    public ByteBuffer[] getFrames(FileChannel source) throws IOException {
