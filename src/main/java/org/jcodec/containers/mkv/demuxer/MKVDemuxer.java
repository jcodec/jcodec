...
public final class MKVDemuxer implements Demuxer {
	...
	public static class AudioTrack implements SeekableDemuxerTrack {
		...
		public Packet nextFrame() throws IOException {
			...
			return Packet.createPacket(data, b.absoluteTimecode, Math.round(samplingFrequency), 1, 0, false,
					ZERO_TAPE_TIMECODE);
		}
		...
		public Packet getFrames(int count) {
			...
			return Packet.createPacket(data, firstBlockInAPacket.absoluteTimecode, Math.round(samplingFrequency),
