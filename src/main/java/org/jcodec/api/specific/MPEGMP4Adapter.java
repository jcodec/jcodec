 ...
 * 
 * Frame grabber adapter for MPEG 1/2 in MP4 combination
 * 
 * @author Stan Vitvitskyy
 * 
 */
public class MPEGMP4Adapter extends CodecContainerAdaptor {

    public MPEGMP4Adapter(SeekableDemuxerTrack track) {
        super(track);
    }
