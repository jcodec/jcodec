 ...
 * 
 * Frame grabber adapter for AVC in MTS combination
 * 
 * @author Stan Vitvitskyy
 * 
 */
public class AVCMTSAdapter extends CodecContainerAdaptor {

    public AVCMTSAdapter(SeekableDemuxerTrack track) {
        super(track);
    }
