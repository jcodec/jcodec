 ...
 * 
 * Frame grabber adapter for MPEG 1/2 in MTS combination
 * 
 * @author Stan Vitvitskyy
 * 
 */
public class MPEGMTSAdapter extends CodecContainerAdaptor {

    public MPEGMTSAdapter(SeekableDemuxerTrack track) {
        super(track);
    }
