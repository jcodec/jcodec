...
class RgbToYuv420p : Transform {
    ...
    companion object {
        @JvmStatic
        fun rgb2yuv(r: Byte, g: Byte, b: Byte, out: ByteArray) {
            val rS = r + 128
            val gS = g + 128
            val bS = b + 128
            ...
            u = u + 128 shr 8
            v = v + 128 shr 8
            out[0] = MathUtil.clip(y - 112, -128, 127).toByte()
            out[1] = MathUtil.clip(u, -128, 127).toByte()
            out[2] = MathUtil.clip(v, -128, 127).toByte()
        }
    }
}