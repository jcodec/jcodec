...
public class BaseH264ES {
    protected IntObjectMap<PictureParameterSet> pps = new IntObjectMap<PictureParameterSet>();
    protected IntObjectMap<SeqParameterSet> sps = new IntObjectMap<SeqParameterSet>();

    // POC and framenum detection
    protected int prevFrameNumOffset;
    protected int prevFrameNum;
    protected int prevPicOrderCntMsb;
    protected int prevPicOrderCntLsb;
    ...
    protected int calcPoc(int absFrameNum, NALUnit nu, SliceHeader sh) {
    ...
    protected int calcPOC2(int absFrameNum, NALUnit nu, SliceHeader sh) {
    ...
    protected int calcPOC1(int absFrameNum, NALUnit nu, SliceHeader sh) {
    ...
    protected int calcPOC0(NALUnit nu, SliceHeader sh) {
    ...
    protected SliceHeader readSliceHeader(ByteBuffer buf, NALUnit nu) {
    ...
    protected boolean sameFrame(NALUnit nu1, NALUnit nu2, SliceHeader sh1, SliceHeader sh2) {
    ...
    protected Packet detectPoc(ByteBuffer result, NALUnit nu, SliceHeader sh) {
        ...
        return new Packet(result, idrFn + (poc >> 1), 1, 1, frameNo++, nu.type == NALUnitType.IDR_SLICE, null, poc);
    }
