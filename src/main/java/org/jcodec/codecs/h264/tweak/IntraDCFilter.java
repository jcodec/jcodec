...
import org.jcodec.codecs.transcode.InplaceDeblocker;
...
public class IntraDCFilter implements H264Handler {
    ...
    public IntraDCFilter(VP8Handler vp8, int chr1QpOffset, int chr2QpOffset, int mbWidth, int mbHeight,
