...
public class TestINxN {
    ...
    public void testMBlockCABAC1() throws IOException {
        ...
        ByteBuffer yuv = NIOUtils.fetchFrom(new File("src/test/resources/h264/cabac/iNxN_1/16x16.yuv"));
    ...
    public void testMBlockCABAC2() throws IOException {
        ...
        ByteBuffer yuv = NIOUtils.fetchFrom(new File("src/test/resources/h264/cabac/iNxN_2/32x32_1.yuv"));
    ...
    public void testMBlockCABAC3() throws IOException {
        ...
        ByteBuffer yuv = NIOUtils.fetchFrom(new File("src/test/resources/h264/cabac/iNxN_3/32x32_2.yuv"));
        Assert.assertArrayEquals(getAsIntArray(yuv, 1024), out.getPlaneData(0));
        Assert.assertArrayEquals(getAsIntArray(yuv, 256), out.getPlaneData(1));
        Assert.assertArrayEquals(getAsIntArray(yuv, 256), out.getPlaneData(2));
    }
    ...
    public void testMBlockCABAC4() throws IOException {
        ...
        ByteBuffer yuv = NIOUtils.fetchFrom(new File("src/test/resources/h264/cabac/iNxN_4/32x32_3.yuv"));
        Assert.assertArrayEquals(getAsIntArray(yuv, 1024), out.getPlaneData(0));
        Assert.assertArrayEquals(getAsIntArray(yuv, 256), out.getPlaneData(1));
        Assert.assertArrayEquals(getAsIntArray(yuv, 256), out.getPlaneData(2));
    }
    ...
    public void testMBlockCABAC5() throws IOException {
        ...
        ByteBuffer yuv = NIOUtils.fetchFrom(new File("src/test/resources/h264/cabac/iNxN_5/32x32_4.yuv"));
        Assert.assertArrayEquals(getAsIntArray(yuv, 1024), out.getPlaneData(0));
        Assert.assertArrayEquals(getAsIntArray(yuv, 256), out.getPlaneData(1));
        Assert.assertArrayEquals(getAsIntArray(yuv, 256), out.getPlaneData(2));
    }
    ...
    public void testMBlockCAVLC() throws IOException {
        ...
        ByteBuffer yuv = NIOUtils.fetchFrom(new File("src/test/resources/h264/cavlc/iNxN_1/16x16.yuv"));
        Assert.assertArrayEquals(getAsIntArray(yuv, 256), out.getPlaneData(0));
        Assert.assertArrayEquals(getAsIntArray(yuv, 64), out.getPlaneData(1));
        Assert.assertArrayEquals(getAsIntArray(yuv, 64), out.getPlaneData(2));
    }
    ...
    public void testMBlockCAVLC1() throws IOException {
        ...
        ByteBuffer yuv = NIOUtils.fetchFrom(new File("src/test/resources/h264/cavlc/iNxN_2/32x32_1.yuv"));
        Assert.assertArrayEquals(getAsIntArray(yuv, 1024), out.getPlaneData(0));
        Assert.assertArrayEquals(getAsIntArray(yuv, 256), out.getPlaneData(1));
        Assert.assertArrayEquals(getAsIntArray(yuv, 256), out.getPlaneData(2));
    }
    ...
    public void testMBlockCAVLC2() throws IOException {
        ...
        ByteBuffer yuv = NIOUtils.fetchFrom(new File("src/test/resources/h264/cavlc/iNxN_3/32x32_2.yuv"));
        Assert.assertArrayEquals(getAsIntArray(yuv, 1024), out.getPlaneData(0));
        Assert.assertArrayEquals(getAsIntArray(yuv, 256), out.getPlaneData(1));
        Assert.assertArrayEquals(getAsIntArray(yuv, 256), out.getPlaneData(2));
    }
    ...
    public void testMBlockCAVLC3() throws IOException {
        ...
        ByteBuffer yuv = NIOUtils.fetchFrom(new File("src/test/resources/h264/cavlc/iNxN_4/32x32_3.yuv"));
        Assert.assertArrayEquals(getAsIntArray(yuv, 1024), out.getPlaneData(0));
        Assert.assertArrayEquals(getAsIntArray(yuv, 256), out.getPlaneData(1));
        Assert.assertArrayEquals(getAsIntArray(yuv, 256), out.getPlaneData(2));
    }
    ...
    public void testMBlockCAVLC4() throws IOException {
        ...
        ByteBuffer yuv = NIOUtils.fetchFrom(new File("src/test/resources/h264/cavlc/iNxN_5/32x32_4.yuv"));
        Assert.assertArrayEquals(getAsIntArray(yuv, 1024), out.getPlaneData(0));
        Assert.assertArrayEquals(getAsIntArray(yuv, 256), out.getPlaneData(1));
        Assert.assertArrayEquals(getAsIntArray(yuv, 256), out.getPlaneData(2));
    }
