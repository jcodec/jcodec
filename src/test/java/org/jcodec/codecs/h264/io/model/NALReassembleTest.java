...
public class NALReassembleTest
{
    ...
    {
        byte[][] data = new byte[][] { new byte[] { (byte) 0x7C, (byte) 0x81 },
                                       new byte[] { (byte) 0x7C, (byte) 0x81 } };

        byte[] result = new byte[] { (byte) 0xE1 };
    ...
    {
        byte[][] data = new byte[][] { new byte[] { (byte) 0x7C, (byte) 0x81, 0x01, 0x02 },
                                       new byte[] { (byte) 0x7C, (byte) 0x01, 0x03, 0x04 },
                                       new byte[] { (byte) 0x7C, (byte) 0x41, 0x05, 0x06 },
                                       new byte[] { (byte) 0x7C, (byte) 0x41, 0x07, 0x08 } };

        byte[] result = new byte[] { (byte) 0xE1, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06 };
    ...
    public void testEmptyFUReassembleWorksStartAndEndOnly()
    {
        ...
        byte[] result = new byte[] { (byte) 0x61 };
    ...
    public void testSimpleReassembleWorksStartAndEndOnly()
    {
        ...
        byte[] result = new byte[] { (byte) 0x61, 0x01, 0x02, 0x03, 0x04 };
    ...
    public void testMultiPacketReassembleWorksStartAndEndOnly()
    {
        ...
        byte[] result = new byte[] { (byte) 0x61, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08 };
