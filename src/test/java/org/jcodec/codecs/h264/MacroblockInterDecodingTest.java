...
public class MacroblockInterDecodingTest {
    ...
    public void testMBlockCABAC1() throws IOException {
        ...
        Assert.assertArrayEquals(JCodecUtil2.getAsIntArray(yuv, 1024), out[0].getPlaneData(0));
        Assert.assertArrayEquals(JCodecUtil2.getAsIntArray(yuv, 256), out[0].getPlaneData(1));
        Assert.assertArrayEquals(JCodecUtil2.getAsIntArray(yuv, 256), out[0].getPlaneData(2));
        Assert.assertArrayEquals(JCodecUtil2.getAsIntArray(yuv, 1024), out[1].getPlaneData(0));
        Assert.assertArrayEquals(JCodecUtil2.getAsIntArray(yuv, 256), out[1].getPlaneData(1));
        Assert.assertArrayEquals(JCodecUtil2.getAsIntArray(yuv, 256), out[1].getPlaneData(2));
        Assert.assertArrayEquals(JCodecUtil2.getAsIntArray(yuv, 1024), out[2].getPlaneData(0));
        Assert.assertArrayEquals(JCodecUtil2.getAsIntArray(yuv, 256), out[2].getPlaneData(1));
        Assert.assertArrayEquals(JCodecUtil2.getAsIntArray(yuv, 256), out[2].getPlaneData(2));
    }
